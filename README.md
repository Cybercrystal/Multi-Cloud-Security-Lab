...
<p><em>CloudTrail security-lab-trail actively logging with Terraform provisioning event history</em></p>
...
<p><em>PC multi-cloud-security-lab provisioned via Terraform with dedicated 10.0.0.0/16 CIDR</em></p> 
...
<p><em>SQS queue cloudtrail-logs-queue receiving log notifications from S3</em></p>
...
<p><em>Azure resource group multi-cloud-security-lab provisioned via Terraform in East US</em></p>
...
<p><em>Event Hub Namespace security-lab-eventhub active with insights-operational-logs hub configured</em></p>
...
<p><em>Azure resources: Event Hub Namespace, VNet, Storage Account, and Log Analytics Workspace</em></p>
...
<p><em>6 custom KQL detection rules running in Elastic SIEM, all mapped to MITRE ATT&CK</em></p>
...
<p><em>Live High severity alert fired on IAM credential creation event (Risk Score 73)</em></p>
...
<p><em>6,466 CloudTrail documents ingested and searchable in Elastic SIEM</em></p>
